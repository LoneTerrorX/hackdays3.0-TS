...
const AboutUs: React.FC = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      linkedin:
        "https://www.linkedin.com/in/monaswi-kumar-bharadwaj-051713296/",
    ...
    },
    {
      ...
      linkedin:
        "https://www.linkedin.com/in/bhagyashree-thakuria-816152308?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    ...
    },
    {
      ...
      linkedin:
        "https://www.linkedin.com/in/bikash-bora-b67690256?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    ...
    },
    {
      ...
      linkedin:
        "https://www.linkedin.com/in/arijit-banik-485610246?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
        ...
        >
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-xl text-gray-300 mb-6 text-justify">
              Gauhati University, established in 1948, stands as the oldest and
              largest university in Northeast India, with over 350 affiliated
              colleges offering undergraduate and postgraduate courses across
              seven faculties: Arts, Science, Commerce & Management, Law,
              Medicine & Allied Health Sciences, and Engineering & Technology.
              Situated on the western fringe of Guwahati, approximately 15
              kilometers from the city center, the university’s scenic campus is
              bordered by the majestic Brahmaputra River. It holds the
              distinction of being the first state university in India to
              receive the ISO 9001:2015 Certification with NABCB Accreditation.
              In 2024, Gauhati University achieved an A+ grade with a CGPA of
              3.32 from NAAC, reaffirming its commitment to academic excellence.
              Additionally, the university secured the 44th position in the
              academic category in the prestigious Nature Index 2024, further
              establishing itself as a leading institution in higher education
            ...
            <p className="text-xl text-gray-300 mb-6 text-justify">
              The Department ofInformation Technology under the Faculty of
              Technology, Gauhati University has been established in the year
              2009 for different Undergraduate, Postgraduate and Research
              programmes in the field of Computer and Information Technologies.
            </p>
            <p className="text-xl text-gray-300 mb-6 text-justify">
              HackDays is a premier tech event that brings together coding
              enthusiasts, innovators, and tech lovers for an epic 3-day
              adventure of hackathons, coding challenges, and tech
              competitions.HackDays 3.0 is the flagship Annual TechFest cum
              Hackathon organized by the Department of Information Technology,
              Gauhati University, offering a dynamic platform for students,
              researchers, and professionals to showcase their technical skills,
              creativity, and problem solving abilities. Formerly known as
              Utkranti, the event had four successful seasons from 2018 to 2021.
              It was rebranded as HackDays in 2023, with HackDays 1.0 followed
              by HackDays 2.0 in 2024. Now, we're set to host HackDays 3.0 in
              2025. The event features coding competitions, technical workshops,
              expert talks, and hands-on innovation challenges, engaging
              participants with real-world technological advancements. Our
          ...
          >
            <h2 className="text-3xl font-bold bg-gradient-to-b from-indigo-300 to-red-300 text-transparent bg-clip-text mb-6 text-center">
              Our Vision
            </h2>
            <p className="text-xl text-gray-300 text-center">
              To create an inclusive tech community that empowers individuals to
              push their boundaries, learn new skills & build innovative
