...
export const eventsData = {
  Hackathon: {
    ...
    description:
      "Week Long hackathon to build innovative solutions. Showcase your coding skills and creativity.",
  ...
  CodeGem: {
    ...
    description:
      "Competitive programming contest to solve complex algorithmic challenges within time constraints.",
  ...
  "Typing Speed": {
    ...
    description:
      "Can you type with keyboard as a Stenographer, if yes then this is the perfect opportunity for you!",
  ...
  Cypher: {
    ...
    description:
      "Enter the world of Cypher, where logic meets innovation, and only the sharpest minds prevail. \u2003\u2003f-society :)",
  ...
  Quiz: {
    ...
    description:
      "Revv up your Nervous Engine to outperform & win amazing knowledge with prizes!",
  ...
  FIFA: {
    ...
    description:
      "Show off your virtual football skills in this exciting FIFA tournament.",
  ...
  Valorant: {
    ...
    description:
      "Team-based tactical FPS competition. Coordinate with your squad and outplay opponents.",
  ...
  BGMI: {
    ...
    description:
      "Battle Royale mobile gaming tournament. Survive and become the last team standing.",
    formLink: "https://forms.gle/TannSJ55phKMy2h29",
    prizePool: "4,000 INR",
  },
  Chess: {
    title: "Chess",
    icon: <img src={ChessIcon} alt="Waiting to load" className="h-8 w-8" />,
    description:
  ...
  "IPL Auction": {
    ...
    description:
      "Champions aren’t just bought they’re built with every bid! Who will be the next big steal?",
  ...
  "Graphics Designing": {
    ...
    description:
      "Showcase your creative design skills and artistic vision in this design competition.",
  ...
  "Kala-Kriti": {
    ...
    description:
      "Do you have the artist in you? Combine it with your creativity skills & build something new!",
...
// List of event types
export const eventTypes = Object.keys(
  eventsData
) as (keyof typeof eventsData)[];
...
const EventCard: React.FC<EventCardProps> = ({ eventType }) => {
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-xl transition-transform ease-out duration-500 ${
    ...
    >
      ...
      <div
        className={`absolute inset-0 bg-gradient-to-br from-indigo-600/40 via-purple-700/30 to-blue-800/40 transition-all duration-700 ${
      ...
      <div className="relative h-full border border-indigo-500/40 bg-indigo-900/30 p-7 flex flex-col">
        {/* Prize pool badge */}
        <div
          className={`absolute top-3 right-3 px-3 py-1 rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 text-white text-sm font-semibold transition-all duration-500 ${
        ...
        {/* Icon container */}
        <div
          className={`p-4 rounded-full bg-gradient-to-br from-indigo-600/80 to-purple-700/80 w-fit mb-5 transition-all duration-500 ${
            isHovered
              ? "shadow-lg shadow-indigo-500/30 transform -translate-y-1"
              : ""
          }`}
        >
          <div
            className={`transition-all duration-500 ${
              isHovered ? "text-white scale-110" : "text-indigo-100"
            }`}
          >
            {eventData.icon}
          </div>
        ...
        <div className="mb-3 relative">
          ...
          <div
            className={`absolute -bottom-1 left-0 h-0.5 bg-gradient-to-r from-indigo-400 to-purple-500 transition-all duration-700 ${
        ...
        {/* Description */}
        <p className="text-indigo-100 mb-7 flex-grow leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {eventTypes.map((event) => (
            <EventCard key={event} eventType={event} />
          ))}
        </div>
      </div>
    </div>
