    ...
    <div className="min-h-screen bg-gray-900 text-white py-16 px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-2xl mb-6 text-justify leading-relaxed">
          Step into the high-stakes world of cricket’s biggest auction! Witness
          franchises battle it out to secure the best players, strategic buys,
          and game-changing picks. Who will go for the highest bid? Who will be
          the next big steal? Be part of the thrill!
        </p>
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg mt-8">
          ...
          <ul className="space-y-3">
            <li>
              {" "}
              <strong>-</strong> Each team will consist of 3-5 members
            </li>
            <li>
              {" "}
              <strong>-</strong> Each team needs to form a squad of 9-players
            </li>
            <li>
              {" "}
              <strong>-</strong> Each team gets a fixed purse to build their
              squad
            </li>
            <li>
              {" "}
              <strong>-</strong> Each team may have a maximum of 3-overseas
              players
            </li>
            <li>
              {" "}
              <strong>- </strong> Out of those 9-players: minimum of 3-batsmen,
              2-all rounders & 3-bowlers are mandatory
            </li>
          </ul>
        </div>
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg mt-8">
          ...
          <ul className="space-y-3">
            <li>
              ⚡ <strong>Format:</strong> Each player will consist of 3-5
              members
            </li>
            <li>
              💰 <strong>Budget:</strong> Each team gets 100 Crore INR to build
              their squad for the auction
            </li>
            <li>
