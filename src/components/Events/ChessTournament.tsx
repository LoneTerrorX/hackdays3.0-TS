    ...
    <div className="min-h-screen bg-gray-900 text-white py-16 px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-2xl mb-6 text-justify leading-relaxed font-newamsterdam">
          Step into the arena of strategic battles and test your intellect in
          the TechFest Chess Tournament! <br /> Whether you're a upcoming
          grandmaster or a budding chess enthusiast, this is your chance to
          showcase your tactical brilliance, outmaneuver opponents, and claim
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg mb-8">
          ...
          <ul className="space-y-3">
            <li>
              🕒 <strong>Timing:</strong> 2:00 PM Onwards
            </li>
            <li>
              ⏳ <strong>Time Control:</strong> 5+2
            </li>
            <li>
              ⚔️ <strong>Game Format:</strong> Knockout Tournament, Single-Game
              Elimination
            </li>
            <li>
